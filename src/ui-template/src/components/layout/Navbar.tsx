...
import { Moon, Sun, Box, Home, Settings, Menu, X, LogIn, ShoppingCart, Package, ClipboardList } from "lucide-react";
...
const navLinks = [
  ...
  { href: "/orders", label: "Orders", icon: <ClipboardList size={15} /> },
        ...
        <div className="max-w-5xl mx-auto px-4 h-14 flex items-center gap-6">
          ...
          <div className="flex items-center gap-2 ml-auto sm:ml-0">
            ...
            <button
              ...
              className="relative p-2 rounded-lg text-neutral-500 hover:text-neutral-700 hover:bg-neutral-100 dark:text-neutral-400 dark:hover:text-neutral-200 dark:hover:bg-neutral-800 transition-colors cursor-pointer"
